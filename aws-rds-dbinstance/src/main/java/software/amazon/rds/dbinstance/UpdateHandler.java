...
public class UpdateHandler extends BaseHandlerStd {
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
            .then(progress -> {
                try {
                    ...
                    return Commons.handleException(progress, e, software.amazon.rds.dbinstance.common.ErrorRuleSets.MODIFY_DB_INSTANCE, requestLogger);
                }
                return progress;
            })
            .then(progress -> {
            ...
            .then(progress -> Commons.execOnce(progress, () -> {
                try {
                    ...
                    return Commons.handleException(progress, ex, software.amazon.rds.dbinstance.common.ErrorRuleSets.MODIFY_DB_INSTANCE, requestLogger);
                }
    ...
    private ProgressEvent<ResourceModel, CallbackContext> unsetMaxAllocatedStorage(
        ...
        try {
            ...
            return Commons.handleException(progress, exception, ErrorRuleSets.MODIFY_DB_INSTANCE, requestLogger);
        }
        return progress;
    }
