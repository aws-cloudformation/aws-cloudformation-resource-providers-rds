...
public abstract class BaseUpdateHandler extends BaseHandlerStd {

    public BaseUpdateHandler(final HandlerConfig config) {
        super(config);
    }

    protected abstract ProgressEvent<ResourceModel, CallbackContext> updateDbInstance(
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        final Tagging.TagSet previousTags = Tagging.TagSet.builder()
                ...
                .resourceTags(TranslatorV19.translateTagsToSdk(request.getPreviousResourceState().getTags()))
                .build();
    ...
    private ProgressEvent<ResourceModel, CallbackContext> setParameterGroupName(
        ...
        DescribeDbParameterGroupsResponse response = rdsProxyClient.injectCredentialsAndInvokeV2(
                TranslatorV19.describeDbParameterGroupsRequest(dbParameterGroupName),
        ...
        final DescribeDbEngineVersionsResponse describeDbEngineVersionsResponse = rdsProxyClient.injectCredentialsAndInvokeV2(
                TranslatorV19.describeDbEngineVersionsRequest(dbParameterGroupFamily, engine, engineVersion),
