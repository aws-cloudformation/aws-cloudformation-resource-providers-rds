...
public class UpdateHandlerTest extends AbstractHandlerTest {
    ...
    @Test
    public void handleRequest_ModifyDbSnapshot_NotFound() {
        ...
        verify(rdsProxy.client(), times(1)).modifyDBSnapshot(any(ModifyDbSnapshotRequest.class));
    ...
    public void handleRequest_SimpleTagUpdate_Success() {
        ...
        when(rdsProxy.client().modifyDBSnapshot(any(ModifyDbSnapshotRequest.class)))
                .thenReturn(ModifyDbSnapshotResponse.builder().dbSnapshot(DB_SNAPSHOT_MODIFYING).build());
    ...
    public void handleRequest_SoftFailingTaggingOnRemoveTags() {
        ...
        test_handleRequest_base(
                ...
                ResourceHandlerRequest.<ResourceModel>builder()
                        .previousSystemTags(translateTagsToRequest(TAG_LIST))
                        .systemTags(translateTagsToRequest(TAG_LIST_EMPTY)),
                () -> DB_SNAPSHOT_AVAILABLE,
                () -> RESOURCE_MODEL_BUILDER().build(),
                () -> RESOURCE_MODEL_BUILDER().build(),
                expectSuccess()
    ...
    public void handleRequest_SoftFailingTaggingOnAddTags() {
        ...
        test_handleRequest_base(
                context,
                ResourceHandlerRequest.<ResourceModel>builder()
                        .previousSystemTags(translateTagsToRequest(TAG_LIST_EMPTY))
                        .systemTags(translateTagsToRequest(TAG_LIST)),
                () -> DB_SNAPSHOT_AVAILABLE,
                () -> RESOURCE_MODEL_BUILDER().build(),
                () -> RESOURCE_MODEL_BUILDER().build(),
                expectSuccess()
